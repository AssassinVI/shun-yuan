                  ...
                  <FancyBox3 text={'優勢比較'} width={'90%'}>
                    <div className="all_box ems_page1">
                        ...
                        <div className='box2'>
                           ...
                           <h3>導入EMS系統前後差異</h3>
                           <p>國内自2018年起，開放讓有充電樁設置需求的住戶，可採後拉的方式安裝，但該方案僅電動車發展初期的權宜作法，未來電動車數量持續增加，就可能面臨既有線路容量不足的問題因此能一次到位的「專設一戶搭配MS電能管理系統」整合方案無論在用電安全、易於管理及線材集中設的美觀上，都更符合電動車發展的大趨勢，有助於提升社區競爭力與歸屬感。</p>
